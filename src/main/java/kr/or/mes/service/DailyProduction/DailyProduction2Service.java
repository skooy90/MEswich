...
/**
 * 금일 생산계획 Service 인터페이스
 * 금일 생산계획 관리 비즈니스 로직을 담당
 * 
 * @author MES System
 * @version 1.0
 * @since 2024-10-17
 */
public interface DailyProduction2Service {
    ...
    /**
     * 금일 생산계획 실제 수량 업데이트 처리 (비즈니스 로직 포함)
     * @param dailyProduction 실제 수량 업데이트할 금일 생산계획 정보
     * @return 업데이트 결과 메시지
     */
