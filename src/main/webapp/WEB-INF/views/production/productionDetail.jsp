        ...
        <div class="detail-container">
            ...
            <c:if test="${not empty production}">
                <table class="info-table">
                    ...
                    <tr>
                        <th>생성일</th>
                        <td><fmt:formatDate value="${production.createdDate}" pattern="yyyy-MM-dd HH:mm" /></td>
                    </tr>
                    <c:if test="${not empty production.updatedDate}">
                    <tr>
                        <th>수정일</th>
                        <td><fmt:formatDate value="${production.updatedDate}" pattern="yyyy-MM-dd HH:mm" /></td>
                    </tr>
                    </c:if>
                </table>
                ...
                <div class="button-group">
                    ...
                    <a href="/mes/production/list" class="btn btn-secondary">목록으로</a>
                </div>
            </c:if>
        </div>
    </main>
